...
class MaterialEntry(models.Model):
    ...
    description = models.TextField(
        max_length=1000, help_text=("Short description about the materials under this category.")
    )
...
class MaterialFile(models.Model):
    ...
    description = models.TextField(max_length=200, help_text=("Short description about the file."))
